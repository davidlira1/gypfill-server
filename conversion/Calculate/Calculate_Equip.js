var calculateEquip = function(estimate, gypExists, concExists) {
      if (gypExists) {
            ...
            if (estimate.gyp.labor.method === "Pump") {
                  var pumpTime_: pumpTime_ = pumpTime(estimate.totals.gypBags) //so it is good to have the the total pumpTime for everything
...
var equipCostsConc = function(assem, concPumpCostOption, mobilizations) {
      assem.equip = {}
      if (assem.concYds > 2.37) {
