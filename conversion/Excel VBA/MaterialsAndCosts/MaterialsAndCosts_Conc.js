Sub materialsAndCostsConc(assem As Dictionary, dict As Dictionary, wageType As String, city As String, zipCode As Variant, saturdayConc As String, overrideConcBarrelMix As String)
      ...
      If assem("concYds") <= 2.37 And overrideConcBarrelMix = "No" And assem("section") <> "Stairs" Then '2.37 is about 64 cuft, which is also 64 maximizer bags
          'USE BAGS
