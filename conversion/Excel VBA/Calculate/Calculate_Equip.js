Sub calculateEquip(estimate As Dictionary, gypExists As Boolean, concExists As Boolean)
      ...
      End If
End Sub
Sub equipCostsConc(assem As Dictionary, concPumpCostOption As String, mobilizations As Integer, overrideConcBarrelMix As String)
      assem.Add "equip", New Dictionary
      If assem("concYds") > 2.37 Or overrideConcBarrelMix = "Yes" Or assem("section") = "Stairs" Then
