Sub laborAndCostsConc(assem As Dictionary, drivingTimeHrs As Double, wageType As String, miles As Integer, saturdayConc As String, numOfFloors As Byte, overrideConcBarrelMix As String)
      Dim dict As Dictionary
      assem.Add "labor", New Dictionary
      If assem("concYds") <= 2.37 And overrideConcBarrelMix = "No" And assem("section") <> "Stairs" Then
            'MAXIMIZER LABOR
