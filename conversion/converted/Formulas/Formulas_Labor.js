...
var gypLabor = function(wageType, structureType, SF, SFsm, gypThick, difficultyLevel, gypType, miles, overnight, saturday, estimate, overrideGypBarrelMix) {
      ...
      dict = getValues("Gyp_DifficultyLevel", {"Level": difficultyLevel}, ["Extra Laborers"]);
      ...
      if (SF <= 400 && overrideGypBarrelMix === "No") {
            dict = getValuesBasedOnNum("Labor_SmallPours", gypSqFt, ["Laborers", "Foam/Primer", "String Line", "Flagmen", "Pumper", "Bobcat", "Baggers", "Screeder", "Hose Pourer", "Hose Puller"]);
    ...
    //HOUSE AND BIGGER THAN 900 SF
            ...
            dict = getValuesBasedOnNum(tableName, gypSqFt, ["Laborers", "String Line", "Flagmen", "Foam/Primer", "Pumper", "Bobcat", "Baggers", "Screeder", "Hose Pourer", "Hose Puller"]);
      ...
      //BUILDING
            ...
            dict = getValuesBasedOnNum(tableName, gypSqFt, ["Laborers", "Flagmen", "Foam/Primer", "Pumper", "Bobcat", "Baggers", "Screeder", "Hose Pourer", "Hose Puller"]);
            ...
            if (gypType === "CMD") {
                  ...
                  dict = getValuesBasedOnNum("Labor_Buildings_CMDFlutes", gypSqFt, ["Laborers", "Flagmen", "Foam/Primer", "Pumper", "Bobcat", "Baggers", "Screeder", "Hose Pourer", "Hose Puller"]);
      ...
      if (miles > dict.Miles) {
            dict2 = getValues("Prices_AfterMileThreshold", {"Description": "House Threshold"}, [SF]);
...
var addMobilsCost = function(mobils, mobilCost, wageType) {
      ...
      return {
            addMobilsCostProduction: mobils * dict["Price/Day"] * 8,
