Sub gypLabor(wageType As String, structureType As String, SF As Long, SFsm As Long, gypThick As Double, difficultyLevel As String, gypType As String, miles As Variant, overnight As Boolean, saturday As String, estimate As Dictionary)
      ...
      If SF <= 900 Then
            ...
            labor("laborers").Add "Laborers", dict("Laborers") + labor("laborers")("extraLaborers")
    ...
    'HOUSE AND BIGGER THAN 900 SF
      ...
      'BUILDING
      ElseIf structureType = "Building" Or structureType = "Multi-Building" Then
            If SFsm = 0 Then
