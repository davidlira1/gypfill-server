...
Function maximizerLaborers(yds As Double, addMobils As Byte) As Dictionary
      ...
      Dim dict As Dictionary: Set dict = getValues("Labor_ConcBag", Array("Type"), Array("Maximizer"), Array("CuYds/Bag", "Laborers", "Finishers"))
      Dim sets As Byte: sets = Round((yds / dict("CuYds/Bag")) + 0.49)
      ml.Add "sets", sets
